...
<head>
  ...
  <title>CedHosting Dashboard</title>
  <!-- Favicon -->
      ...
      <div class="navbar-inner">
        ...
        <hr class="my-3">
          ...
          <ul class="navbar-nav sub-menu collapse" id="products">
            <li class="nav-item">
              <a class="nav-link" href="products/createCategory.php">
                <i class="ni ni-planet text-orange"></i>
                <span class="nav-link-text">Create Category</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="products/addProduct.php">
                <i class="ni ni-pin-3 text-primary"></i>
                <span class="nav-link-text">Add Product</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="products/viewProducts.php">
          ...
          <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
            <li class="nav-item dropdown">
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold">Hello <?php echo $uName;  ?></span>
                  </div>
                </div>
              </a>
              <div class="dropdown-menu  dropdown-menu-right ">
                ...
                <a href="products/logout.php" class="dropdown-item">
